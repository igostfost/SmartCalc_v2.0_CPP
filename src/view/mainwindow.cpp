...
void MainWindow::on_pushButton_equal_clicked() {
  ...
  try {
    ...
    // В случае исключения, создаем QMessageBox и отображаем сообщение об ошибке
...
void MainWindow::on_pushButton_FUNCT_clicked() {
  ...
  // Отправляем сигнал после открытия окна
  ...
  if (!str2.isEmpty() && isNumeric) {
    ...
    QMessageBox::critical(this, "Ошибка",
                          "В уравнении только число!Для построения графика "
